...
func NewAccountValueRepository(db *sql.DB) *AccountValueRepository {
	return &AccountValueRepository{db: db}
}

// GetTotalValue fetches the total value, cash, assets value, and available cash for a user.
func (r *AccountValueRepository) GetAggregatedValue(ctx context.Context, userId uuid.UUID) (TotalValue, error) {
...
func (r *AccountValueRepository) GetSpecificAccountValue(ctx context.Context, accountId uuid.UUID) (AccountValue, error) {
